<section>
    ...
    <form class="mt-6 space-y-6" method="post" action="{{ route('profile.update') }}">
        ...
        <div>
            ...
            <x-forms.text-input class="mt-1 block w-full" id="name" name="name" type="text" :value="old('name', $user->name)"
        ...
        <div>
            ...
            <x-forms.text-input class="mt-1 block w-full" id="email" name="email" type="email" :value="old('email', $user->email)"
